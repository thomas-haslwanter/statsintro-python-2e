...
import L10_1_weibull_demo
import L10_2_lifelines_survival
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_interactivePlots(self):
        ISP_interactive_plots.normal_plot()
        ISP_interactive_plots.position_on_screen()
        ISP_interactive_plots.show_and_pause()
        ISP_interactive_plots.wait_for_input()
        ISP_interactive_plots.key_selection()
    ...
    def test_ologit(self):
        ...
        self.assertAlmostEqual(test_val, 2.6676470588235293, places=5)
